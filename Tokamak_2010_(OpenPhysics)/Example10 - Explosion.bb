...
AppTitle "Open Physics. Example10 / Explosion"
AntiAlias True
...
cam		=	CreateCamera()
			...
			CreateListener Cam, .02
			PositionEntity cam,30,5,-30
...
height=10
area=10
For x = -area To area Step 2
	For y = yp To height Step 2
	 For z = -area To area Step 2
		box.tok	=	opBodyCreateBox(2,2,2,1)
					opBodySetPos(box\body,x,y,z)
